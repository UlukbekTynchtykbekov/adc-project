            ...
            <div className="row">
                ...
                <div className="company">
                    <div className="table company__table">
                                            ...
                                            <div key={el._id} className="contact__menu">
                                                <div className="menu__description">
                                                    ...
                                                    <div className="contact__des company__des">
                                                        <svg className="contact__icon company__icon" width="26" height="26"
                                                            ...
                                                            <path d="M5.68848 8.12549L13.001 13.813L20.3135 8.12549"
                                                                  stroke="black" strokeWidth="1.00189" strokeLinecap="round"
                                                                  strokeLinejoin="round"/>
                                                        </svg>
                                                    ...
                                                    <div className="contact__des company__des">
                                                        <svg className="contact__icon company__icon" width="21" height="21"
                                                            ...
                                                            <path
                                                                ...
                                                                stroke="black" strokeWidth="1.00189" strokeMiterlimit="10"/>
                                                        </svg>
                                                        <a className="contact__text company__contact-text"
                                                    ...
                                                    <div className="contact__des company__des">
                                                        <svg className="contact__icon company__icon" width="29" height="29"
                                                            ...
                                                            <div key={schedule._id} className="contact__des company__des">
                                                                <svg className="contact__icon company__icon" width="33"
                                                                    ...
                                                                    <path
                                                                        ...
                                                                        strokeMiterlimit="10"/>
                                                                    <path d="M16.5 8.24829V17.5309H22.6884" stroke="black"
                                                                          strokeWidth="1.00189" strokeLinecap="round"
                                                                          strokeLinejoin="round"/>
                                                                </svg>
                                                                <p className="contact__text company__contact-text">
                        ...
                        {!companyLoading && companyData?.data.length <= 0 && <div>нет данных</div>}
                    </div>
                </div>
            </div>
        </section>
